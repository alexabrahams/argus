Use the following benchmark script to tune the following parameters against specific hardware:
     argus/benchmarks/lz4_tuning/benchmark_lz4.py

Execute it on the server hardware you intend to run your application, and based on the results, you can tune argus/_compression.py parameters:
