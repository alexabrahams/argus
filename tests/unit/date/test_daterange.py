...
from argus.date import DateRange, string_to_daterange, CLOSED_CLOSED, CLOSED_OPEN, OPEN_CLOSED, OPEN_OPEN
...
test_ranges_for_bounding = {
    ...
    "closed_by_default": (DateRange("20110101", "20111231"), dt(2011, 1, 1), dt(2011, 12, 31), False, True, True),
    "closed_explicitly": (
        DateRange("20110101", "20111231", CLOSED_CLOSED),
        dt(2011, 1, 1),
        dt(2011, 12, 31),
        False,
        True,
    ...
    "closed_open": (
        DateRange("20110101", "20111231", CLOSED_OPEN),
        dt(2011, 1, 1),
        dt(2011, 12, 31),
        False,
        True,
    ...
    "open_closed": (
        DateRange("20110101", "20111231", OPEN_CLOSED),
        dt(2011, 1, 1),
        dt(2011, 12, 31),
        False,
        False,
    ...
    "open_open": (DateRange("20110101", "20111231", OPEN_OPEN), dt(2011, 1, 1), dt(2011, 12, 31), False, False, False),
}
...
STRING_DR_TESTS = [
    ("20110101", DR1, DateRange(DR1.start.date(), DR1.end.date())),
...
def test_intersection_returns_inner_boundaries():
    ...
    assert (
        ...
        .intersection(DateRange(None, "20110102"))
        .end
        == dt(2011, 1, 2)
    )
    assert (
        ...
        .intersection(DateRange(None, "20110103"))
        .end
        == dt(2011, 1, 2)
    )
    assert (
...
def test_intersection_preserves_boundaries():
    ...
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange("20110101", "20110103", OPEN_CLOSED).intersection(
        DateRange("20110101", "20110102", OPEN_OPEN)
    )
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange("20110101", "20110102", OPEN_OPEN).intersection(
        DateRange("20110101", "20110103", OPEN_CLOSED)
    )
    assert DateRange("20110102", "20110103", OPEN_OPEN) == DateRange("20110102", "20110103", OPEN_OPEN).intersection(
        DateRange("20110101", "20110103", CLOSED_OPEN)
    )

    assert DateRange("20110102", "20110103", CLOSED_OPEN) == DateRange(
        "20110102", "20110103", CLOSED_OPEN
    ).intersection(DateRange("20110101", "20110103", CLOSED_OPEN))
    assert DateRange("20110102", "20110103", CLOSED_OPEN) == DateRange(
        "20110101", "20110103", CLOSED_OPEN
    ).intersection(DateRange("20110102", "20110103", CLOSED_OPEN))

    # Matching boundaries
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange("20110101", "20110102", CLOSED_OPEN).intersection(
        DateRange("20110101", "20110102", OPEN_OPEN)
    )
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange("20110101", "20110102", OPEN_OPEN).intersection(
