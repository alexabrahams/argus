...
from argus.exceptions import DataIntegrityException
from argus.store._ndarray_store import NdarrayStore, _promote_struct_dtypes
...
def test_concat_and_rewrite_checks_written():
    ...
    collection.find.return_value = [
        {"_id": sentinel.id, "segment": 47, "compressed": True, "sha": "abc0"},
...
def test_concat_and_rewrite_checks_different_id():
    ...
    collection.find.side_effect = [
        [
            ...
            {"_id": sentinel.id_6, "segment": 51, "compressed": False},
        ],  # 3 appended items
...
def test_concat_and_rewrite_checks_fewer_updated():
    ...
    collection.find.side_effect = [
        [
            ...
            {"_id": sentinel.id_6, "segment": 52, "compressed": False},
        ],  # 3 appended items
