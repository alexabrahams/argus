...
from argus.date import DateRange, CLOSED_OPEN, CLOSED_CLOSED, OPEN_OPEN, OPEN_CLOSED
...
def test_write_dataframe(chunkstore_lib):
    ...
    df = DataFrame(
        data={"something": [100, 200, 300, 400, 500, 600, 700, 800]}, index=DatetimeIndex(date_range, name="date")
    )
