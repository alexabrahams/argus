...
class TestServerV2(Workspace):
    ...
    def _get_hostname(self):
        ...
        if self._server_class == "thread":
            ...
            return get_ephemeral_host() if self.random_hostname else CONFIG.fixture_hostname
    ...
    def _get_port(self, default_port):
        ...
        if self._server_class == "thread":
            return (
                get_ephemeral_port(host=self._listen_hostname) if self.random_port else self._get_pseudo_random_port()
            )
