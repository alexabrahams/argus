...
def main():
    usage = """
    Check a Argus Library for inconsistencies.
    """
    setup_logging()
    ...
    parser.add_argument(
        "--library", nargs="+", required=True, help="The name of the library. e.g. 'argus_jblackburn.lib'"
    )
    ...
    for lib in opts.library:
        ...
        if opts.f:
            database_name, _ = ArgusLibraryBinding._parse_db_lib(lib)
