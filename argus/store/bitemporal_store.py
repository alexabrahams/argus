...
from argus.multi_index import groupby_asof
...
class BitemporalStore:
    ...
    def read(self, symbol, as_of=None, raw=False, **kwargs):
        ...
        if raw:
            return BitemporalItem(
                symbol=symbol,
                library=self._store._argus_lib.get_name(),
                data=item.data,
    ...
    def write(self, *args, **kwargs):
        ...
        raise NotImplementedError(
            "Direct write for BitemporalStore is not supported. Use append instead" "to add / modify timeseries."
        )
