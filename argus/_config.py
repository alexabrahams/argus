...
ARGUS_AUTO_EXPAND_CHUNK_SIZE = bool(os.environ.get("ARGUS_AUTO_EXPAND_CHUNK_SIZE"))
...
ARGUS_FORWARD_POINTERS_RECONCILE = False
ARGUS_FORWARD_POINTERS_CFG = FwPointersCfg.DISABLED
...
#     argus/benchmarks/lz4_tuning/README.txt
...
# -------------------------------
ENABLE_CACHE = not bool(os.environ.get("ARGUS_DISABLE_CACHE"))
